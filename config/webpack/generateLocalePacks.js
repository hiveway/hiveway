...
const localesJsonPath = path.join(__dirname, '../../app/javascript/etherhive/locales');
...
locales.forEach(locale => {
  ...
  const localeDataPath = [
    ...
    `../../app/javascript/etherhive/locales/locale-data/${baseLocale}.js`,
...
//
import messages from '../../app/javascript/etherhive/locales/${locale}.json';
import localeData from ${JSON.stringify(localeDataPath)};
import { setLocale } from '../../app/javascript/etherhive/locales';
