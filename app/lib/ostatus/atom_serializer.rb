...
class OStatus::AtomSerializer
  ...
  def author(account)
    ...
    append_element(author, 'etherhive:scope', account.locked? ? :private : :public)
  ...
  def add_namespaces(parent)
    ...
    parent['xmlns:etherhive'] = OStatus::TagManager::MTDN_XMLNS
  end
  ...
  def serialize_status_attributes(entry, status)
    ...
    append_element(entry, 'etherhive:scope', status.visibility)
