...
const PageOne = ({ acct, domain }) => (
  <div className='onboarding-modal__page onboarding-modal__page-one'>
    <div className='onboarding-modal__page-one__lead'>
      <h1><FormattedMessage id='onboarding.page_one.welcome' defaultMessage='Welcome to EtherHive!' /></h1>
      <p><FormattedMessage id='onboarding.page_one.federation' defaultMessage='EtherHive is a network of independent servers joining up to make one larger social network. We call these servers instances.' /></p>
    </div>
...
const PageSix = ({ admin, domain }) => {
  ...
  return (
    <div className='onboarding-modal__page onboarding-modal__page-six'>
      ...
      {adminSection}
      <p><FormattedMessage id='onboarding.page_six.github' defaultMessage='EtherHive is free open-source software. You can report bugs, request features, or contribute to the code on {github}.' values={{ github: <a href='https://github.com/etherhive/etherhive' target='_blank' rel='noopener'>GitHub</a> }} /></p>
      <p><em><FormattedMessage id='onboarding.page_six.appetit' defaultMessage='Bon Appetit!' /></em></p>
    </div>
  );
};
